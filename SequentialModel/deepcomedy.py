...
Original file is located at
    https://colab.research.google.com/drive/1mFd-ZP1UJRnzXjFStKEKDGRv6zADlV_q
...
This mehod needs two file, we called it generated.txt (the same for the Metics) and Inferno.txt. In this case we can use as original file evrythign we need.
"""
...
This method needs two file:
*   generated.txt: the file generated by the network
*   Inferno canto I.txt: the original file

Both with UTF-8 Encoding!
